...
class UnetPlusPlus(nn.Module):
    def __init__(self, in_ch, num_classes, deep_supervision=False):
        super(UnetPlusPlus, self).__init__()    # 继承类
        ...
        self.stage_0 = ContinusParalleConv(in_ch, 64, pre_Batch_Norm=False)
